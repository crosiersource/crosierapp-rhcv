...
INSERT INTO cfg_entmenu(uuid,label,icon,tipo,program_uuid,pai_uuid,ordem,css_style,inserted,updated,estabelecimento_id,user_inserted_id,user_updated_id)
VALUES ('983f5444-b146-4541-a1c6-d05c2a26d6c3','Dashboard','fas fa-columns','ENT','27cfaa1b-8f08-4577-a9fb-e325b943bb63','70fca045-26d9-4e26-9626-5d35f8f268a0',0,null,now(),now(),1,1,1);
