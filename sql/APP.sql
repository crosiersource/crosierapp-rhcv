...
VALUES('05042f6e-31ad-4243-9a09-91524a762300','crosierapp-rhcv','Módulo do Crosier para Cadastro de Currículos','70fca045-26d9-4e26-9626-5d35f8f268a0',now(),now(),1,1,1);
...
VALUES ('27a3f478-027c-4a4b-917d-cd3f88a36de5','CVs','fas fa-file-alt','CROSIERCORE_APPENT','27cfaa1b-8f08-4577-a9fb-e325b943bb63',null,0,null,now(),now(),1,1,1);

-- Entrada de menu raíz para este CrosierApp (NÃO É EXIBIDO)
INSERT INTO cfg_entmenu(uuid,label,icon,tipo,program_uuid,pai_uuid,ordem,css_style,inserted,updated,estabelecimento_id,user_inserted_id,user_updated_id)
VALUES ('70fca045-26d9-4e26-9626-5d35f8f268a0','crosierapp-rhcv (MainMenu)','','PAI','',null,0,null,now(),now(),1,1,1);
